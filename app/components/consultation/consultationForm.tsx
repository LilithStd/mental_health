...
export default function ConsultationForm() {
    ...
    return (
        <div className={`flex flex-col w-full  max-w-6xl  rounded-large `}>
            <form ref={ref} action={action} className={`mx-auto  p-4 items-center rounded-large bg-mainContainer max-content-main-container`}>
                ...
                <div className={`flex gap-4 flex-col w-full items-center h-full`}>
                    ...
                    <label className={`flex flex-col gap-2 w-1/2`}>
                        <span className={`font-jura font-bold`}>{ConsultationPageContent[locale].message}*:</span>
                ...
                <div className={`flex justify-center m-4`}>
                    <button type="submit" className={`font-bold font-jura items-center mb-2 mt-2  w-1/4  rounded-large p-4 bg-buttonContainer`}>{ConsultationPageContent[locale].buttonText}</button>
                </div>
