...
export default function CreateArticle() {
    ...
    return (
        <form
            ...
            className={`flex flex-col gap-4 p-4 w-full ${sizes.width.maxWidth} ${rounded.medium} ${THEME_COLOR_SCHEME[currentTheme].subContainer} ${THEME_COLOR_SCHEME[currentTheme].text}`}
        >
