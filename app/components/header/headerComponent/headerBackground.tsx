...
export default function HeaderBackground({ children }: HeaderBackgroundProps) {
    return (
        <div className={`flex backdrop-blur-md  max-w-6xl shadow-md justify-between items-center w-full rounded-large  bg-primary-color/20 border border-primary-color/30 p-4`}>
