...
export default function PricesBlock({ locale }: { locale: string }) {
        ...
        <div className={`flex gap-4 p-6 justify-center items-center`}>
            <div className={`grid grid-cols-2 p-6 justify-center items-center`}>
                <div className={`flex flex-col gap-4`}>
                    ...
                    <Link href={routesAdaptive.pricing.root} className={`mt-4 px-4 py-2 bg-buttonContainer w-fit rounded-large`}>View Pricing</Link>
                </div>
