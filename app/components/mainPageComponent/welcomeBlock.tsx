        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 w-full p-4 rounded-large items-center bg-primary-color/20 shadow-lg backdrop-blur-md border border-primary-color/30`}>
            ...
            <div>
                ...
                <div className={`flex flex-col gap-4 mt-4 `}>
                    <Link href={routesAdaptive.consultation.root} className={`p-4 w-fit bg-primary-color/40 backdrop-blur-md border border-primary-color/50 font-geistSans shadow-lg font-bold italic rounded-full hover:bg-accentElement hover:scale-105`}>{WelcomeBlockContent[localeAdapted].SIGN_UP_BUTTON}</Link>
                    <Link href={routesAdaptive.tests.root} className={`p-4 w-fit 
                         bg-primary-color/40 backdrop-blur-md border border-primary-color/50 font-geistSans font-bold italic shadow-lg rounded-full hover:bg-accentElement hover:scale-105`}>{WelcomeBlockContent[localeAdapted].TESTS_BUTTON}</Link>
                </div>
