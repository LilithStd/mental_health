    ...
    return (
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 w-full p-4  `}>
            ...
            <div>
                ...
                <div className={`flex flex-col gap-2`}>
                    <h3 className={`text-xl font-semibold mt-2`}>{WelcomeBlockContent[localeAdapted].TITLE_3}</h3>
                ...
                <div className={`flex flex-col gap-2`}>
                    <h3 className={`text-xl font-semibold mt-2`}>{WelcomeBlockContent[localeAdapted].PRIVILEGES_TITLE}</h3>
