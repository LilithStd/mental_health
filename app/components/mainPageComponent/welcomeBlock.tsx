...
export default function WelcomeBlock() {
    ...
    return (
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 w-full p-4  `}>
            ...
            <div>
                <h2 className={`text-2xl font-jura`}>{WelcomeBlockContent[localeAdapted].TITLE}</h2>
                <p className={`font-poiret text-xl`}>{WelcomeBlockContent[localeAdapted].DESCRIPTION}</p>
                <div className={`flex flex-col gap-2 `}>
                    <h3 className={`text-xl font-jura mt-2`}>{WelcomeBlockContent[localeAdapted].TITLE_2}</h3>
                ...
                <div className={`flex flex-col gap-2`}>
                    <h3 className={`text-xl font-jura mt-2`}>{WelcomeBlockContent[localeAdapted].TITLE_3}</h3>
                ...
                <div className={`flex flex-col gap-2`}>
                    <h3 className={`text-xl font-alumni-sans-pinstripe font-bold mt-2`}>{WelcomeBlockContent[localeAdapted].PRIVILEGES_TITLE}</h3>
