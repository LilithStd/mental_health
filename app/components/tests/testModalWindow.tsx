    ...
    return (
        <div className={`${THEME_COLOR_SCHEME[currentTheme].subContainer} p-6 rounded-lg border-2 flex flex-col items-center justify-center gap-4`}>
            ...
            <div className={`flex gap-4`}>
                ...
                <button disabled={!currentAuthUser} className={`${!currentAuthUser ? 'opacity-50 cursor-not-allowed bg-gray-600' : 'cursor-pointer'} ${THEME_COLOR_SCHEME[currentTheme].buttonContainer}  px-4 py-2 ${rounded.medium}`}>
