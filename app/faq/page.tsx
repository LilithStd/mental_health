    ...
    return (
        <div className={`flex flex-col indents-main-container  flex-1 items-center`}>
            <div className={`flex w-full flex-col flex-1 max-w-6xl  rounded-large bg-mainContainer p-4 `}>
                ...
                <details className={`list-disc list-inside mb-4`}>
                ...
                <details>
                    ...
                    <p> 6. Is it possible to get help online?

                        Yes, consultations are available online (video).
                        Online consultations are suitable for most conditions if an in-person examination is not necessary.</p>
                </details>
                <details>
