  ...
  return  (
        <div className={`flex flex-col indents-main-container  flex-1 items-center`}>
            ...
            <div className={`flex w-full flex-col flex-1 mt-6 rounded-large`}>
                <h2 className={`text-3xl justify-center text-center font-bold`}>{ABOUT_PAGE_CONTENT[locale].contact}</h2>
                <p className={`text-center mt-2`}>{ABOUT_PAGE_CONTENT[locale].contact}</p>
            </div>
            </div>
