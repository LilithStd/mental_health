...
export default function CreateElementLibraryPage() {
  return (
    <div className={`flex flex-col indents-main-container  flex-1 items-center`}>
            ...
            <form>
                <input type="text" placeholder="Title" className={`w-full p-2 mb-4 rounded-large bg-primary-color/50 border border-primary-color/30`} />
                <textarea placeholder="Content" className={`w-full p-2 mb-4 rounded-large bg-primary-color/50 border border-primary-color/30`} rows={10}></textarea>
